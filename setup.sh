...
echo ""
echo "🤖 Person Detection (optional AI feature):"
echo "  ./install_person_detection.sh - Install AI detection dependencies"
echo "  python test_person_detection.py - Test detection system"
echo "  Set ENABLE_PERSON_DETECTION=true in .env to enable"
echo "  Then watcher-capture will include automatic person detection"
